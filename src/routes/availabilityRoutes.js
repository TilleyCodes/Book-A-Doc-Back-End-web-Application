...
availabilityRouter.get('/:availablityId', async (req, res) => {
...
availabilityRouter.patch('/:availablityId', async (req, res) => {
  try {
...
availabilityRouter.delete('/:availablityId', async (req, res) => {
  try {
